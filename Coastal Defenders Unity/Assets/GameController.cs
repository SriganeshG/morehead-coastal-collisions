...
public class GameController : MonoBehaviour
{
    ...
    void Start() {
        ...
        maxResourceNumbers = new int[5] {4, 3, 2, 1, 4};
    ...
    public void NextScreen() {
        ...
        PlayerPrefs.SetInt("sandDune",currentResourceNumbers[0]);
        PlayerPrefs.SetInt("oysterReef", currentResourceNumbers[1]);
        PlayerPrefs.SetInt("bulkhead", currentResourceNumbers[2]);
        PlayerPrefs.SetInt("floodGate", currentResourceNumbers[3]);
        PlayerPrefs.SetInt("seaGrass", currentResourceNumbers[4]);
    ...
    private void addResource(int resourceNumber) {
        ...
        foreach (var val in currentResourceNumbers)
        {
            Debug.Log(val);
        }
    }
